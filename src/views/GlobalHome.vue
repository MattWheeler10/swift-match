...
<template>
  ...
  <SectionBlock :headline="g.howItWorks.headline">
    <WorkflowFlow :steps="g.howItWorks.steps" :label="g.howItWorks.supportingLine" />
    <RouterLink :to="g.howItWorks.link.to" class="btn btn--ghost">
